    ...
    try {
      ...
      for (let i = 0; i < totalBatches; i++) {
        const response = await fetch(
          `https://nocodb.qurvii.com/api/v2/tables/mhhxiprapvyqjtf/records?offset=${
            i * BATCH_SIZE
...
//        const createdAtObj = item.created_at ? new Date(item.created_at) : null;
// const createdAtTime = createdAtObj?.getTime() || 0;
